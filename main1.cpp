...
time_t tstart, t1, t2, t3, t4, t5 ,t6 ,t7 ,t8 ,t9 , t10, tend;
...
std::cout << "Fifth write block took "<< difftime(t6, t5) <<" second(s)."<< std::endl;
...
std::cout << "Sixth write block took "<< difftime(t7, t6) <<" second(s)."<< std::endl;
...
std::cout << "Seventh write block took "<< difftime(t8, t7) <<" second(s)."<< std::endl;

base += pitch;
write_array(base,n,val,nrows,ncols);
t9 = time(0);

std::cout << "Eigth write block took "<< difftime(t9, t8) <<" second(s)."<< std::endl;

base += pitch;
write_array(base,n,val,nrows,ncols);
t10 = time(0);

std::cout << "Ninth write block took "<< difftime(t10, t9) <<" second(s)."<< std::endl;

base += pitch;
write_array(base,n,val,nrows,ncols);
tend = time(0);

std::cout << "Tenth write block took "<< difftime(tend, t10) <<" second(s)."<< std::endl;
