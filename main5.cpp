...
std::cout << "Evenly distributed 'random' block write in second(s)."<< std::endl;
...
std::cout << "Fourth write block took "<< difftime(tend, t4) <<" second(s)."<< std::endl;
std::cout << "Total time Array 5 was  "<< difftime(tend, tstart) <<" second(s)."<< std::endl;
